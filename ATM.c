...
// This is program is coded in c programming and if you want to convert it into c++ then kindly add some header files and instead of printf and scanf use cout and cin for input nd output.
    ...
    while (continue_transaction != 0)
    {
        ...
        case 1:
            ...
            case 2:
                ...
                printf("\n\t\t****************** Thank you for banking with ADITYA ******************");
